...
def restricted_weighted_sum(model, m, alpha, u, tol=False, solver='scip', timelimit=3600):
    """
    ...
    if results.solver.termination_condition == TerminationCondition.maxTimeLimit:
        raise TimeoutError('Solver did not finish within timelimit of {timeout}s')
